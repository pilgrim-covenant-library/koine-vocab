...
const hw6Section1Questions: MCQQuestion[] = [
  ...
  // Q11-12: Biblical verses with fem/neut participles
  {
    ...
    correctIndex: 0,
    explanation: 'εἰσελθοῦσα is a feminine nominative singular aorist active participle from εἰσέρχομαι ("having entered"). It agrees in gender with γυνή (woman).',
...
const hw6Section3Questions: MCQQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'γεγονός is a neuter nominative singular perfect active participle from γίνομαι. It agrees with the neuter noun ῥῆμα ("this thing that has happened"). This shows how neuter participles must agree with neuter nouns.',
    category: 'biblical-application',
  },
];
...
const hw6Section4Questions: MCQQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'Demonstrative pronouns stand in the predicate position: οὗτος ὁ ἄνθρωπος or ὁ ἄνθρωπος οὗτος ("this man"). They are NOT placed between the article and noun (attributive position), which is where adjectives typically go.',
    category: 'grammar-concept',
  },
...
const hw6Section5Questions: MCQQuestion[] = [
  // Q1-2: Concept Qs
  {
    ...
    correctIndex: 0,
    explanation: 'Reflexive pronouns refer back to the subject of the clause ("I see myself"). They have no nominative form because the reflexive can never be the subject — it always refers to the action\'s subject in an oblique case (gen/dat/acc).',
    category: 'grammar-concept',
  },
  {
    id: 'h6s5-q2',
