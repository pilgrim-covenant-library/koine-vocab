...
const hw7Section1Questions: MCQQuestion[] = [
  // Q1: Concept - middle/passive participle pattern
  {
    id: 'h7s1-q1',
    type: 'mcq',
    question: 'What declension pattern do present middle/passive participles follow?',
    options: ['3-1-3 pattern (like active participles)', '2-1-2 pattern (like adjectives)', '1-3-1 pattern', '3-3-3 pattern'],
    correctIndex: 1,
    explanation: 'Present middle/passive participles follow the 2-1-2 adjective declension pattern: -μενος (masc), -μένη (fem), -μενον (neut), like second/first declension adjectives.',
    category: 'concept',
  },
  // Q2: Concept - aorist passive marker
  {
    ...
    correctIndex: 2,
    explanation: 'The aorist passive participle uses the -θε- (or -θει-) marker, as in λυθείς ("having been loosed"), distinguishing it from aorist middle forms.',
    category: 'concept',
  },
...
const hw7Section2Questions: MCQQuestion[] = [
  // Q1: Concept - perfect tense meaning
  {
    ...
    correctIndex: 1,
    explanation: 'The Greek perfect tense expresses a completed action whose results continue into the present. For example, γέγραπται ("it stands written") describes a past writing whose authority persists.',
    category: 'concept',
  },
...
const hw7Section3Questions: MCQQuestion[] = [
  // Q1: Concept - perfect active participle pattern
  {
    id: 'h7s3-q1',
    type: 'mcq',
    question: 'What declension pattern does the perfect active participle follow?',
    options: ['2-1-2 pattern', '3-1-3 pattern', '1-3-1 pattern', '2-2-2 pattern'],
    correctIndex: 1,
    explanation: 'The perfect active participle follows the 3-1-3 pattern: masculine/neuter use third declension (λελυκώς, λελυκός), while feminine uses first declension (λελυκυῖα).',
    category: 'concept',
  },
  // Q2: Concept - perfect mid/pass participle pattern
  {
    id: 'h7s3-q2',
    type: 'mcq',
    question: 'What declension pattern does the perfect middle/passive participle follow?',
    options: ['3-1-3 pattern', '2-1-2 pattern (like adjectives)', '3-3-3 pattern', '1-1-1 pattern'],
    correctIndex: 1,
    explanation: 'The perfect middle/passive participle follows the 2-1-2 pattern with -μένος, -μένη, -μένον endings, declining like a regular second/first declension adjective.',
    category: 'concept',
  },
  ...
  // Q11-Q12: Biblical application
  {
    ...
    correctIndex: 1,
    explanation: 'ἑωράκαμεν is perfect active indicative 1st person plural from ὁράω ("we have seen"). The perfect tense emphasizes the lasting impact of their eyewitness experience.',
    category: 'biblical-application',
  },
  {
    id: 'h7s3-q12',
