...
const section5QuestionsBase: MCQQuestion[] = [
 ...
 // Q5: ἀλλά
 {
  ...
  options: [
   'ἀλλά expresses strong contrast, while δέ is mild contrast',
 ...
 // Q6: ἐάν vs εἰ
 {
  ...
  options: [
   'εἰ is used with indicative, ἐάν with subjunctive',
 ...
 // Q9: Which conjunction fits this context?
 {
  ...
  correctIndex: 0,
  explanation: 'The giving is the evidence/result of the loving, so ὅτι fits. This echoes John 3:16: "God so loved the world that (ὅτι/ὥστε) he gave..."',
