...
const section1QuestionsBase: MCQQuestion[] = [
 ...
 // Q2: Present vs aorist imperative aspect
 {
  ...
  correctIndex: 0,
  explanation: 'The present imperative commands continuous or repeated action, while the aorist imperative commands a simple, one-time action. This is aspectual, not temporal.',
  category: 'grammar-concept',
 },
...
const section3QuestionsBase: MCQQuestion[] = [
 // Q1: What is a deponent verb?
 {
  ...
  correctIndex: 0,
  explanation: 'A deponent verb has middle or passive morphology but carries an active meaning. ἔρχομαι looks middle (-ομαι ending) but means "I come" (active sense).',
  category: 'grammar-concept',
 },
 ...
 // Q2: Why does ἔρχομαι use middle forms?
 {
  ...
  correctIndex: 0,
  explanation: 'ἔρχομαι is deponent from the Latin deponere. These verbs historically lost their active forms. Some scholars now argue the middle voice simply expresses self-involvement in the action of coming/going.',
  category: 'grammar-concept',
 },
