...
export const verseAnalysisQuestions: PracticeVerseAnalysis[] = [
  ...
  {
    id: 'pp-va02',
    reference: 'Mark 1:15b',
    greek: 'μετανοεῖτε καὶ πιστεύετε ἐν τῷ εὐαγγελίῳ.',
    transliteration: 'metanoeite kai pisteuete en tō euangeliō.',
    referenceTranslation: 'Repent and believe in the gospel.',
    keyTerms: ['repent', 'believe', 'gospel'],
    matchingPairs: [
      { greek: 'μετανοεῖτε', category: 'Present active imperative 2nd plural verb' },
      { greek: 'καί', category: 'Coordinating conjunction' },
      { greek: 'πιστεύετε', category: 'Present active imperative 2nd plural verb' },
      { greek: 'ἐν τῷ εὐαγγελίῳ', category: 'Preposition + dative singular neuter noun with article' },
    ],
    distractorCategories: ['Aorist active indicative verb', 'Nominative singular masculine noun', 'Present active participle'],
  },
  {
    id: 'pp-va03',
    reference: 'Mark 1:11',
  ...
  },
  {
    id: 'pp-va04',
    reference: 'Mark 1:8',
    greek: 'ἐγὼ ἐβάπτισα ὑμᾶς ὕδατι, αὐτὸς δὲ βαπτίσει ὑμᾶς ἐν πνεύματι ἁγίῳ.',
    transliteration: 'egō ebaptisa hymas hydati, autos de baptisei hymas en pneumati hagiō.',
    referenceTranslation: 'I baptized you with water, but he will baptize you with the Holy Spirit.',
    keyTerms: ['I', 'baptized', 'you', 'water', 'he', 'baptize', 'Holy', 'Spirit'],
    matchingPairs: [
      { greek: 'ἐγώ', category: '1st person personal pronoun nominative' },
      { greek: 'ἐβάπτισα', category: 'Aorist active indicative 1st singular verb' },
      { greek: 'ὑμᾶς', category: '2nd person personal pronoun accusative plural' },
      { greek: 'ὕδατι', category: 'Dative singular neuter noun (3rd decl, dative of means)' },
      { greek: 'αὐτός', category: 'Nominative singular masculine pronoun' },
      { greek: 'βαπτίσει', category: 'Future active indicative 3rd singular verb' },
      { greek: 'ἐν πνεύματι ἁγίῳ', category: 'Preposition + dative singular neuter noun + adjective' },
    ],
    distractorCategories: ['Perfect passive indicative verb', 'Genitive plural masculine noun', 'Aorist passive participle'],
  },
  {
    id: 'pp-va05',
    reference: 'Mark 1:17',
