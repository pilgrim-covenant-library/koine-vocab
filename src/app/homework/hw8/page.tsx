...
function Homework8Content() {
  ...
  useEffect(() => {
    ...
    initializeHomework();
  }, [user, homework8.status, startHomework8, loadFromCloud8, syncToCloud8]);
  ...
  const handleSectionClick = (sectionId: HW8SectionId) => {
    if (canAccessSection8(sectionId)) {
  ...
  const handleRedoSection = (sectionId: HW8SectionId) => {
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="space-y-8">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold">Homework 8</h1>
            <p className="text-lg text-muted-foreground">
              3rd Declension, Adjectives & Infinitives
            </p>
            <p className="text-sm text-muted-foreground max-w-xl mx-auto">
              This homework covers 3rd declension nouns and pronouns, adjectives of 3rd and 1st
              declensions (πᾶς, εἷς), irregular adjectives (πολύς, μέγας), infinitives, and verse practice.
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <HomeworkProgress
                currentSection={homework8.currentSection}
                sectionStatuses={Object.fromEntries(
                  sections.map((id) => [id, homework8.sections[id]?.status ?? 'not_started'])
                ) as Record<HW8SectionId, 'not_started' | 'in_progress' | 'completed'>}
                onSectionClick={handleSectionClick}
                canAccess={canAccessSection8}
...
export default function Homework8Page() {
  return <Homework8Content />;
}
